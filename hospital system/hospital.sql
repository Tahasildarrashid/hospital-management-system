...
ON patients
FOR EACH ROW
INSERT INTO trigr VALUES(null,OLD.email,OLD.name,'PATIENT DELETED')
$$
DELIMITER ;
...
ON patients 
FOR EACH ROW 
INSERT INTO trigr VALUES(null,NEW.email,NEW.name,'PATIENT UPDATED')
$$
DELIMITER ;
...
ON patients 
FOR EACH ROW 
INSERT INTO trigr VALUES(null,NEW.email,NEW.name,'PATIENT INSERTED')
$$
DELIMITER ;
